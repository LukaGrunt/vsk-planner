...
function App() {
      ...
      await withRetry(async () => {
        ...
        if (data) {
          setProfileData({
            ...
            orozje: Array.isArray(appData?.weapons) ? appData.weapons : []
          });
        }
      });
    } catch (e) {
  ...
  const addOrozje = () => setProfileData({ ...profileData, orozje: [...profileData.orozje, { vrsta_orozja: '', model_orozja: '', kaliber: '', serijska_stevilka: '' }] });
  const updateOrozje = (i, f, v) => setProfileData({ ...profileData, orozje: profileData.orozje.map((x, j) => j === i ? { ...x, [f]: v } : x) });
  const removeOrozje = (i) => setProfileData({ ...profileData, orozje: profileData.orozje.filter((_, j) => j !== i) });
        ...
        <div className="page-scroll">
          ...
          <div style={{ ...glassCardStyle, padding: '24px', marginBottom: '14px', overflow: 'hidden' }}>
            ...
            {editingProfile ? (
              <div style={{ display: 'grid', gap: '12px' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                  <div><span style={{ color: 'rgba(255,255,255,0.45)', fontSize: '11px', fontWeight: '600', marginBottom: '4px', display: 'block' }}>{t.firstName}</span><input type="text" value={profileData.ime} onChange={(e) => setProfileData({ ...profileData, ime: e.target.value })} style={{ padding: '12px', background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: '#fff', fontSize: '16px', width: '100%', boxSizing: 'border-box' }} /></div>
                  <div><span style={{ color: 'rgba(255,255,255,0.45)', fontSize: '11px', fontWeight: '600', marginBottom: '4px', display: 'block' }}>{t.lastName}</span><input type="text" value={profileData.priimek} onChange={(e) => setProfileData({ ...profileData, priimek: e.target.value })} style={{ padding: '12px', background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: '#fff', fontSize: '16px', width: '100%', boxSizing: 'border-box' }} /></div>
                </div>
                <div><span style={{ color: 'rgba(255,255,255,0.45)', fontSize: '11px', fontWeight: '600', marginBottom: '4px', display: 'block' }}>{t.phone}</span><input type="tel" value={profileData.telefon} onChange={(e) => setProfileData({ ...profileData, telefon: e.target.value })} style={{ padding: '12px', background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: '#fff', fontSize: '16px', width: '100%', boxSizing: 'border-box' }} /></div>
                <div><span style={{ color: 'rgba(255,255,255,0.45)', fontSize: '11px', fontWeight: '600', marginBottom: '4px', display: 'block' }}>{t.morsNumber}</span><input type="text" value={profileData.morsStevilo} onChange={(e) => setProfileData({ ...profileData, morsStevilo: e.target.value })} style={{ padding: '12px', background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: '#fff', fontSize: '16px', width: '100%', boxSizing: 'border-box' }} /></div>
                <div><span style={{ color: 'rgba(255,255,255,0.45)', fontSize: '11px', fontWeight: '600', marginBottom: '4px', display: 'block' }}>Konfekcijska številka (Majica)</span><select value={profileData.konfekcijskaStevilka} onChange={(e) => setProfileData({ ...profileData, konfekcijskaStevilka: e.target.value })} style={{ padding: '12px', background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: profileData.konfekcijskaStevilka ? '#fff' : 'rgba(255,255,255,0.4)', fontSize: '16px', width: '100%', boxSizing: 'border-box' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '12px', marginBottom: '12px' }}>
            ...
            >
              ...
              <span style={{ color: '#fff', fontSize: '14px', fontWeight: '600' }}>Blog</span>
            </a>
            <a
              href="https://vsk.si/"
              target="_blank"
            ...
            >
              ...
              <span style={{ color: '#fff', fontSize: '14px', fontWeight: '600' }}>Website</span>
            </a>
          </div>
          ...
          >
            ...
            <span style={{ color: '#fff', fontSize: '15px', fontWeight: '600' }}>{t.support}</span>
          </a>
